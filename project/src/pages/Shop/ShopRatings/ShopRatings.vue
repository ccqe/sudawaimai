    ...
    <div class="ratings-content">
      <div class="overview">
        <div class="overview-left">
          <h1 class="info-score">{{info.score}}</h1>
          <div class="info-title">综合评分</div>
          <div class="info-rank">高于周边商家99%</div>
        </div>
        <div class="overview-right">
          <div class="score-wrapper">
            <span class="info-title">服务态度</span>
            <Star :score="info.serviceScore" :size="36" />
            <span class="info-score">{{info.serviceScore}}</span>
          </div>
          <div class="score-wrapper">
            <span class="info-title">商品评分</span>
            <Star :score="info.foodScore" :size="36" />
            <span class="info-score">{{info.foodScore}}</span>
          </div>
          <div class="delivery-wrapper">
            <span class="info-title">送达时间</span>
            <span class="info-delivery">{{info.deliveryTime}}分钟</span>
          </div>
        </div>
      </div>
